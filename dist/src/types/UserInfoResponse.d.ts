...
export default interface UserInfoResponse {
    ...
    name?: string;
    /**
     * Casual name of the End-User that may or may not be the same as the given
     * name. For instance, a nickname value of Mike might be returned alongside a
    ...
    picture?: string;
    /**
     * Non-unique shorthand name by which the End-User wishes to be referred to at
